    ...
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 126 }}>
        ...
        <View style={styles.content}>
          ...
          {insights.length ? (
            insights.map((item) => (
              <Card key={item.title} style={styles.insightCard}>
...
const styles = StyleSheet.create({
  ...
  exportButton: { minHeight: 46, borderRadius: 999, backgroundColor: colors.primaryDim, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 12 },
  ...
  timelineIcon: { width: 40, height: 40, borderRadius: 12, alignItems: "center", justifyContent: "center", marginRight: 11 },
  timelineTop: { flexDirection: "row", justifyContent: "space-between", gap: 10 },
  dateText: { color: colors.inkFaint, fontFamily: fonts.bodyMedium, fontSize: 11 },
  loadMore: { alignItems: "center", paddingVertical: 14 },
  loadMoreText: { color: colors.primary, fontFamily: fonts.bodySemiBold, fontSize: 13 },
  floatingHome: { position: "absolute", right: 22, bottom: 22, minHeight: 50, borderRadius: 999, backgroundColor: colors.primary, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingHorizontal: 18, shadowColor: "#0F172A", shadowOpacity: 0.18, shadowRadius: 18, shadowOffset: { width: 0, height: 9 }, elevation: 10 },
