...
const styles = StyleSheet.create({
  ...
  noteCard: { flexDirection: "row", alignItems: "flex-start", backgroundColor: colors.peachDim, borderRadius: 16, padding: 14, marginBottom: 14 },
  noteText: { color: "#F0D2B8", fontFamily: fonts.body, fontSize: 12, marginLeft: 10, flex: 1, lineHeight: 17 },
  toggleRowItem: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", backgroundColor: colors.surface, borderRadius: 16, padding: 14, marginBottom: 10 },
